...
class MainActivity : AppCompatActivity() {
    ...
    private fun updateDisplay(
        ...
        if(billValue != null && billValue > BigDecimal.ZERO) {
            ...
            val tipAmount =  calculateTipAmount(billValue, tipPercent)
            tipAmountTv.text = "Tip Amount: \$%.2f".format(tipAmount)
        } else {
            billValueTv.text = ""
            tipPercentTv.text = ""
            tipAmountTv.text = ""
    ...
    private fun calculateTipAmount(billValue: BigDecimal, tipPercent: Int): BigDecimal {
        return billValue
            .multiply(tipPercent.toBigDecimal())
